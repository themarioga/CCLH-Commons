...
public class GameConfig {
	...
	public static int DEFAULT_NUMBER_OF_ROUNDS_TO_END = 5;
	...
	public GameConfig(ConfigurationService configurationService) {
		...
		DEFAULT_NUMBER_OF_ROUNDS_TO_END = Integer.parseInt(configurationService.getConfiguration("game_default_number_of_rounds"));
