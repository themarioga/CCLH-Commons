...
public enum ErrorEnum {
    ...
    DECK_NOT_FOUND(26L, "Mazo no encontrado"),
    DECK_NOT_FILLED(27L, "Mazo no completado"),
    DECK_ALREADY_EXISTS(28L, "Mazo ya existe"),
    DECK_ALREADY_FILLED(29L, "Mazo ya completado"),
